...
app_produto = Dash(__name__,
                   server=server,
                   url_base_pathname='/dash/produto_loja/')

app_faturamento = Dash(__name__,
                       server=server,
                       url_base_pathname='/dash/loja_faturamento/')

app_curva = Dash(__name__,
                 server=server,
                 url_base_pathname='/dash/curva_abc/')
